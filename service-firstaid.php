            ...
            if (!$user_id) {
                ...
                if (!$has_active_sub) {
                    ...
                    try {
                        ...
                        $admin_msg = "🚑 <b>درخواست جدید نوبت دوره کمک‌های اولیه (رایگان VIP)</b>\n\n";
                        $admin_msg .= "👤 نام کاربر: {$first_name} {$last_name}\n";
                        $admin_msg .= "📞 تلفن: {$phone}\n";
                        $admin_msg .= "📧 ایمیل: {$email}\n";
                        $admin_msg .= "🔗 لینک پنل ادمین: https://farsifahr.com/panel/first-aid-course-appointment-requests/{$success_req_id}/edit\n";
            ...
            <?php if ($success): ?>
                <div class="premium-card p-5 text-center text-white">
                    ...
                    <p class="fs-5 mb-4 text-muted">
                        پشتیبانی سایت به زودی برای هماهنگی و ارسال تاییدیه نوبت دوره Erste Hilfe با شما تماس خواهد گرفت.
                    </p>
                    <div class="mt-4">
