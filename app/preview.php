...
require_once __DIR__ . '/../incloud/i18n.php';
...
// Mock sessions to prevent errors, but don't require real user
...
// Override current question based on query param for navigation within iframe
if (isset($_GET['q'])) {
    $requestedQ = intval($_GET['q']);
    if (in_array($requestedQ, $selectedQuestions)) {
        $currentQuestionIndex = array_search($requestedQ, $selectedQuestions);
    }
}
$_SESSION['current_question_id'] = $selectedQuestions[$currentQuestionIndex];
...
$isVip = true; // Give VIP access to see translations in preview
$questionLimit = null;
$maxAccessibleId = 999999999;
$isAdmin = false;
$user_id = 0; // Anonymous
?>
<!DOCTYPE html>
...
function hideTranslationContent() {
    ...
    if (!explanationActive) {
        ...
        function loadCurrentQuestion() {
            ...
            fetch("../incloud/get_preview_question.php", {
                method: "POST",
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded"
                },
